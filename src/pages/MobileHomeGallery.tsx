...
import mobileHomeGalleries from '../data/mobile-home-galleries.json';
        ...
        >
            <div className="max-w-7xl mx-auto bg-white/40 backdrop-blur-md p-8 md:p-12 rounded-3xl shadow-xl">
                ...
                <div className="flex flex-col gap-20">
                    {mobileHomeGalleries.map((gallery, galleryIndex) => (
                ...
                {selectedImage !== null && (
                    ...
                    >
                        <motion.img
                            ...
                            src={mobileHomeGalleries[selectedImage.galleryIndex].images[selectedImage.imageIndex]}
                            alt="Fullscreen view"
                        ...
                        <div className="absolute bottom-6 left-6 md:bottom-8 md:left-8 text-white/70 font-sans text-sm tracking-widest uppercase">
                            {mobileHomeGalleries[selectedImage.galleryIndex].title} — {selectedImage.imageIndex + 1} / {mobileHomeGalleries[selectedImage.galleryIndex].images.length}
                        </div>
                    </div>
                )}
            </div>
