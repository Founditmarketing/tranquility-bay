...
import cabinGalleries from '../data/cabin-galleries.json';
        ...
        <div className="min-h-screen bg-resort-mist pt-32 pb-24 px-6 md:px-12">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col gap-20">
                    {cabinGalleries.map((gallery, galleryIndex) => (
                ...
                {selectedImage !== null && (
                    ...
                    >
                        <motion.img
                            ...
                            src={cabinGalleries[selectedImage.galleryIndex].images[selectedImage.imageIndex]}
                            alt="Fullscreen view"
                        ...
                        <div className="absolute bottom-6 left-6 md:bottom-8 md:left-8 text-white/70 font-sans text-sm tracking-widest uppercase">
                            {cabinGalleries[selectedImage.galleryIndex].title} — {selectedImage.imageIndex + 1} / {cabinGalleries[selectedImage.galleryIndex].images.length}
                        </div>
                    </div>
                )}
            </div>
